...
i want when add a new child to add photo for the child and allow to open the camera and select the devices and allow to upload a photo 

cluadnary 

show the user number index for every child 
